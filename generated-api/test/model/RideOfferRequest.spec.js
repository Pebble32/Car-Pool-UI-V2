...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarPoolApi.RideOfferRequest();
  });
  ...
  describe('RideOfferRequest', function() {
    it('should create an instance of RideOfferRequest', function() {
      // uncomment below and update the code to test RideOfferRequest
      //var instance = new CarPoolApi.RideOfferRequest();
      //expect(instance).to.be.a(CarPoolApi.RideOfferRequest);
    });
