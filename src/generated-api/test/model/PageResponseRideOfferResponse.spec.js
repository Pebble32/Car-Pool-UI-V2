...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarPoolApi.PageResponseRideOfferResponse();
  });
  ...
  describe('PageResponseRideOfferResponse', function() {
    it('should create an instance of PageResponseRideOfferResponse', function() {
      // uncomment below and update the code to test PageResponseRideOfferResponse
      //var instance = new CarPoolApi.PageResponseRideOfferResponse();
      //expect(instance).to.be.a(CarPoolApi.PageResponseRideOfferResponse);
    });
