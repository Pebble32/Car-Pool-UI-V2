...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CarPoolApi.PageResponseUserResponse();
  });
  ...
  describe('PageResponseUserResponse', function() {
    it('should create an instance of PageResponseUserResponse', function() {
      // uncomment below and update the code to test PageResponseUserResponse
      //var instance = new CarPoolApi.PageResponseUserResponse();
      //expect(instance).to.be.a(CarPoolApi.PageResponseUserResponse);
    });
